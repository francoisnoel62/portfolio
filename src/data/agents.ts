...
export const DATA: Record<Lang, Record<AgentId, any>> = {
    fr:{
      profil:{
        ...
        intro:"Lecture rapide : Je suis un développeur fullstack senior qui combine exécution produit, backend solide, frontend moderne et culture IA appliquée. Le signal rare : je sais passer du besoin métier au logiciel fiable, puis l’expliquer et le transmettre.",
        data:{
          metrics:[
          ...
          signals:[
            ...
            {k:"IA appliquée", t:"Je transforme les LLM en fonctions produit", d:"Réécriture, analyse narrative, workflows agentiques, context engineering et réflexion architecture au-delà du prompt."},
    ...
    en:{
      profil:{
        ...
        intro:"Fast read: I'm a senior fullstack developer combining product execution, solid backend work, modern frontend craft and practical AI culture. The rare signal: I move from business need to reliable software, then explain and scale that knowledge.",
        data:{
          metrics:[
          ...
          signals:[
            ...
            {k:'Applied AI', t:'I turn LLMs into product features', d:'Rewriting, narrative analysis, agentic workflows, context engineering and architecture thinking beyond prompting.'},
